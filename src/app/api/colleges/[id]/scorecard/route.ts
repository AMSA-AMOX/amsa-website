...
export async function GET(
  ...
  if (!dbErr && row) {
    const profile: ScorecardProfile = {
      satAvg:               row.sat_avg       ?? null,
      sat25Read:            row.sat_read_25   ?? null,
      sat75Read:            row.sat_read_75   ?? null,
      sat25Math:            row.sat_math_25   ?? null,
      sat75Math:            row.sat_math_75   ?? null,
      act25:                row.act_25  ?? null,
      actMid:               row.act_mid ?? null,
      act75:                row.act_75  ?? null,
      testRequirements:     row.test_requirements ?? null,
      enrollment:           row.ugds       ?? null,
      gradStudents:         row.grad_students ?? null,
      retentionRate:        row.retention_rate ?? null,
      gradRate:             row.completion_rate_4yr ?? row.c150_4 ?? null,
      consumerCompletionRate: row.consumer_completion_rate ?? null,
      defaultRate3yr:       row.default_rate_3yr ?? null,
      menShare:             row.demo_men    ?? null,
      womenShare:           row.demo_women  ?? null,
      partTimeShare:        row.share_part_time ?? null,
      shareFirstGen:        row.share_first_gen ?? null,
      share25Older:         row.share_25_older  ?? null,
      shareLowIncome:       row.share_low_income ?? null,
      demoWhite:            row.demo_white    ?? null,
      demoBlack:            row.demo_black    ?? null,
      demoHispanic:         row.demo_hispanic ?? null,
      demoAsian:            row.demo_asian    ?? null,
      demoTwoOrMore:        row.demo_two_or_more ?? null,
      demoNonResidentAlien: row.demo_nonresident_alien ?? null,
      avgNetPriceOverall:   row.avg_net_price_overall ?? null,
      netPrice0_30k:        row.net_price_0_30k   ?? null,
      netPrice30k_48k:      row.net_price_30k_48k ?? null,
      netPrice48k_75k:      row.net_price_48k_75k ?? null,
      netPrice75k_110k:     row.net_price_75k_110k ?? null,
      netPrice110kPlus:     row.net_price_110k_plus ?? null,
      pellGrantRate:        row.pell_grant_rate       ?? null,
      federalLoanRate:      row.federal_loan_rate     ?? null,
      studentsWithAnyLoan:  row.students_with_any_loan ?? null,
      medianDebtCompleters: row.median_debt_completers ?? null,
      medianDebtMonthly:    row.median_debt_monthly    ?? null,
      debt90th:             row.debt_90th ?? null,
      debt75th:             row.debt_75th ?? null,
      debt25th:             row.debt_25th ?? null,
      debt10th:             row.debt_10th ?? null,
      facultySalary:        row.faculty_salary  ?? null,
      ftFacultyRate:        row.ft_faculty_rate ?? null,
      endowment:            row.endowment       ?? null,
      carnegieBasic:        row.carnegie_basic  ?? null,
