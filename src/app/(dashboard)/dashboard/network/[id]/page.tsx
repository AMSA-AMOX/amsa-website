            ...
            <div className="px-5 sm:px-8">
              <div className="py-6 border-b border-gray-200">
                ...
                {loadingProfile ? (
                  ...
                  <Link
                    href="/welcome"
                    className="w-full sm:w-auto inline-flex items-center justify-center sm:justify-start gap-2 px-4 py-2.5 rounded-lg border border-dashed border-gray-300 text-sm font-medium text-[#001049] hover:border-[#001049] hover:bg-gray-50 transition"
                  >
